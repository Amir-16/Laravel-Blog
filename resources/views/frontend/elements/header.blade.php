...
<html lang="en">
    <head>
        ...
        <!-- Google Fonts -->
        <link href="{{asset('https://fonts.googleapis.com/css?family=Montserrat:400,600&display=swap')}}" rel="stylesheet">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="tb-contact">
                            <p><i class="fas fa-envelope"></i>amirulislam00026@mail.com</p>
