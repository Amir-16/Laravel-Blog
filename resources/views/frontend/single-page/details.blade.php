				...
				<div class="col-lg-8 col-md-12 no-right-padding">
					...
					<div class="main-post">
						...
						<div class="blog-post-inner">
							...
							<h3 class="title"><a href="#"><b>{{$details->title}}</b></a></h3>

							<p class="para">{{$details->content}}</p>

							<div class="post-image"><img src="{{asset('public/upload/posts_image/'.$details->image)}}" alt="Blog Image"></div>
					...
					<div class="card h-100">
						<div class="single-post post-style-1">
							...
							<div class="blog-info">
								...
								<h4 class="title"><a href="{{route('post.details',$random->id)}}"><b>{{$random->title}}</b></a></h4>
