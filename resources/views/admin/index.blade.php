    ...
    <div class="sl-mainpanel">
      ...
      <footer class="sl-footer">
        ...
        <div class="footer-right d-flex align-items-center">
          ...
          <a target="_blank" class="pd-x-5" href="{{asset('https://www.facebook.com/sharer/sharer.php?u=http%3A//themepixels.me/starlight')}}"><i class="fa fa-facebook tx-20"></i></a>
          <a target="_blank" class="pd-x-5" href="{{asset('https://twitter.com/home?status=Starlight,%20your%20best%20choice%20for%20premium%20quality%20admin%20template%20from%20Bootstrap.%20Get%20it%20now%20at%20http%3A//themepixels.me/starlight')}}"><i class="fa fa-twitter tx-20"></i></a>
        </div>
      </footer>
    </div><!-- sl-mainpanel -->
    <!-- ########## END: MAIN PANEL ########## -->
